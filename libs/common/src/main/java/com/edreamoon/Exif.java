...
/**
 * Created by jianfeng.li on 2018/1/5.
 */
...
public class Exif {
    ...
    public static int getOrientation(String path) {
        try {
            ...
            return getDegree(ori);
        } catch (IOException e) {
            Log.e("lijf", "getOrientation: " + e.getMessage());
        }
    ...
    /**
     * @param jpeg 图片流
     * @return 返回图片的旋转信息 0, 90, 180, or 270.
     */
