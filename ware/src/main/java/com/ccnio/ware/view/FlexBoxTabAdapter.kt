 ...
 */
class FlexBoxTabAdapter : RecyclerView.Adapter<FlexBoxTabAdapter.FlexHolder>(), View.OnClickListener {
...
//        val tag = v.tag
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FlexHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.flex_box_tab_item, parent, false)
