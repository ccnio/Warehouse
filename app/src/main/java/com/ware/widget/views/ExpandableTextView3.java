...
/**
 * Created by jianfeng.li on 21-6-7.
 */
 ...
 */
public class ExpandableTextView3 extends AppCompatTextView {
...
//    private View.OnClickListener mOnClickListener;
    ...
    public ExpandableTextView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
    }
    ...
    private void initialize() {
        mOpenSuffixColor = Color.GREEN;
        mCloseSuffixColor = Color.RED;
...
//                    }
    ...
    private void open() {
        if (hasAnimation) {
            ...
            ExpandableTextView3.super.setMaxLines(Integer.MAX_VALUE);
            setText(mOpenSpannableStr);
    ...
    private void close() {
        if (hasAnimation) {
            ...
            ExpandableTextView3.super.setMaxLines(mMaxLines);
            setText(mCloseSpannableStr);
            if (mOpenCloseCallback != null) {
